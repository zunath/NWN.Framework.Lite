...
using DamageType = NWN.Framework.Lite.Enum.DamageType;
using RacialType = NWN.Framework.Lite.Enum.RacialType;
...
namespace NWN.Framework.Lite
{
    public partial class NWScript
    {
        ...
        {
            Internal.NativeFunctions.StackPushGameDefinedStructure((int)EngineStructureType.Effect, eParentEffect);
            Internal.NativeFunctions.StackPushGameDefinedStructure((int)EngineStructureType.Effect, eChildEffect);
        ...
        public static int GetEffectInteger(Effect eEffect, int nIndex)
        {
            ...
            Internal.NativeFunctions.StackPushGameDefinedStructure((int) EngineStructureType.Effect, eEffect.Handle);
