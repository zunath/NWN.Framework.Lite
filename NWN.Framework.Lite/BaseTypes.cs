...
namespace NWN.Framework.Lite
{
    public partial class Effect
    {
        ...
        ~Effect() { Internal.NativeFunctions.FreeGameDefinedStructure((int)EngineStructureType.Effect, Handle); }
    ...
    public partial class Event
    {
        ...
        ~Event() { Internal.NativeFunctions.FreeGameDefinedStructure((int)EngineStructureType.Event, Handle); }
    ...
    public partial class Location
    {
        ...
        ~Location() { Internal.NativeFunctions.FreeGameDefinedStructure((int)EngineStructureType.Location, Handle); }
    ...
    public partial class Talent
    {
        ...
        ~Talent() { Internal.NativeFunctions.FreeGameDefinedStructure((int)EngineStructureType.Talent, Handle); }
    ...
    public partial class ItemProperty
    {
        ...
        ~ItemProperty() { Internal.NativeFunctions.FreeGameDefinedStructure((int)EngineStructureType.ItemProperty, Handle); }
    ...
    public partial class SQLQuery
    {
        ...
        ~SQLQuery() { Internal.NativeFunctions.FreeGameDefinedStructure((int)EngineStructureType.SQLQuery, Handle); }
