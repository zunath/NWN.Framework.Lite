...
using NWN.Framework.Lite.Core.NWScript.Enum.VisualEffect;
using Alignment = NWN.Framework.Lite.Core.NWScript.Enum.Alignment;
using DamageType = NWN.Framework.Lite.Core.NWScript.Enum.DamageType;
using RacialType = NWN.Framework.Lite.Core.NWScript.Enum.RacialType;
