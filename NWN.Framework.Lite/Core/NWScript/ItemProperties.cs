using System;
using NWN.Framework.Lite.Core.NWScript.Enum;
using NWN.Framework.Lite.Core.NWScript.Enum.Item;
using NWN.Framework.Lite.Core.NWScript.Enum.Item.Property;
using Alignment = NWN.Framework.Lite.Core.NWScript.Enum.Item.Property.Alignment;
using AlignmentGroup = NWN.Framework.Lite.Core.NWScript.Enum.Item.Property.AlignmentGroup;
using DamageType = NWN.Framework.Lite.Core.NWScript.Enum.Item.Property.DamageType;
using SpellSchool = NWN.Framework.Lite.Core.NWScript.Enum.SpellSchool;

namespace NWN.Framework.Lite.Core.NWScript
{
