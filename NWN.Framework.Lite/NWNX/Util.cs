...
namespace NWN.Framework.Lite.NWNX
{
    public static class Util
    {
        ...
        public static uint CreateDoor(string sResRef, Location locLocation, string sNewTag)
        {
            ...
            var vPosition = NWScript.GetPositionFromLocation(locLocation);

            Internal.NativeFunctions.nwnxPushString(sNewTag);
            Internal.NativeFunctions.nwnxPushFloat(NWScript.GetFacingFromLocation(locLocation));
            ...
            Internal.NativeFunctions.nwnxPushObject(NWScript.GetAreaFromLocation(locLocation));
