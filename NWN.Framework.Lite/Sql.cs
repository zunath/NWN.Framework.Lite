...
namespace NWN.Framework.Lite
{
    public partial class NWScript
    {
        ...
        {
            Internal.NativeFunctions.StackPushGameDefinedStructure((int)EngineStructureType.SQLQuery, sqlQuery);
        ...
        public static IntPtr SqlPrepareQueryCampaign(string sDatabase, string sQuery)
        {
            ...
            return Internal.NativeFunctions.StackPopGameDefinedStructure((int)EngineStructureType.SQLQuery);
        }
        ...
        public static uint SqlGetObject(IntPtr sqlQuery, int nIndex, IntPtr lSpawnAt, uint oInventory = OBJECT_INVALID)
        {
            ...
            Internal.NativeFunctions.StackPushGameDefinedStructure((int)EngineStructureType.Location, lSpawnAt);
            Internal.NativeFunctions.StackPushInteger(nIndex);
            Internal.NativeFunctions.StackPushGameDefinedStructure((int)EngineStructureType.SQLQuery, sqlQuery);
