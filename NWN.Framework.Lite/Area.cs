...
namespace NWN.Framework.Lite
{
    public partial class NWScript
    {
        ...
        /// </summary>
        public static ArtificialityType GetIsAreaNatural(uint oArea)
        {
            Internal.NativeFunctions.StackPushObject(oArea);
        ...
        ///   If an object other than an area is specified, will use the area that the object is currently in.
        /// </summary>
        public static int GetAreaSize(AreaDimensionType nAreaDimensionType, uint oArea = OBJECT_INVALID)
        {
            Internal.NativeFunctions.StackPushObject(oArea);
            Internal.NativeFunctions.StackPushInteger(nAreaDimensionType.InternalValue);
        ...
        {
            Internal.NativeFunctions.StackPushGameDefinedStructure((int)EngineStructureType.Location, at);
        ...
        public static void SetTileMainLightColor(Location lTileLocation, int nMainLight1Color, int nMainLight2Color)
        {
            ...
            Internal.NativeFunctions.StackPushGameDefinedStructure((int)EngineStructureType.Location, lTileLocation);
        ...
        {
            Internal.NativeFunctions.StackPushGameDefinedStructure((int)EngineStructureType.Location, lTile);
